...
/**
* Defines generic error, generated in stage of lexical analysis
*
* @package    blocks
...
/**
 * @class block_formal_langs_scanning_error
 * 
 * A special class for error, which is used, when string is being scanned
 * and some error is found
 */
