...
M.preg_authoring_tools_script = (function ($) {
    ...
    tree_node_clicked : function (e) {
        ...
        description_node_clicked: function(e){
            ...
            var arr=mouse_target.attr('id').split(/_/);
            if (arr[0]==="description"){
                var tmp=arr;
            }
            else{
                var tmp=$(mouse_target.parents(".description")[0]).attr('id').split(/_/);
            }
            var indfirst=tmp[3],
                indlast=tmp[4];
            self.load_content(indfirst, indlast, null, null);
    ...
    display_content : function (t, g, d, si, indfirst, indlast, indfirstorig, indlastorig) {
        ...
        if (typeof d != 'undefined') {
            ...
            self.desc_hnd().click(self.description_node_clicked);
        }
    ...
    load_content : function (indfirst, indlast, problem_ids, problem_type) {
        ...
        self.desc_hnd().unbind('click',self.description_node_clicked);
